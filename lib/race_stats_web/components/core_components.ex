...
defmodule RaceStatsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RaceStatsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RaceStatsWeb.Gettext, "errors", msg, opts)
    end
  end
